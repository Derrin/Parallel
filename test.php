...
<?php
	...
	try {
        ...
        if (count(get_object_vars($results)) == 0) {
            ...
            echo '<br>Name:';
            echo '<a href="http://' . $region . ".battle.net/api/wow/character/" . $server . "/" . $char . '?fields=talents,stats,guild,items,progression,professions,titles">' . $character->getName();
            echo '</a>';
            ...
            echo '<table border="1">';
            echo '<tr><td><b>Slot</b></td><td><b>Item</b></td></tr>';
            echo '<tr><td><b>Head</b></td><td>'.$items['head']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Neck</b></td><td>'.$items['neck']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Shoulder</b></td><td>'.$items['shoulder']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Back</b></td><td>'.$items['back']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Chest</b></td><td>'.$items['chest']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Wrists</b></td><td>'.$items['wrist']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Hands</b></td><td>'.$items['hands']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Waist</b></td><td>'.$items['waist']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Legs</b></td><td>'.$items['legs']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Feet</b></td><td>'.$items['feet']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Finger 1</b></td><td>'.$items['finger1']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Finger 2</b></td><td>'.$items['finger2']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Trinket 1</b></td><td>'.$items['trinket1']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Trinket 2</b></td><td>'.$items['trinket2']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Weapon</b></td><td>'.$items['mainhand']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Off Hand</b></td><td>'.$items['offhand']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Shirt</b></td><td>'.$items['shirt']->buildWowHeadToolTip().'</td></tr>';
            echo '<tr><td><b>Tabard</b></td><td>'.$items['tabard']->buildWowHeadToolTip().'</td></tr>';
            echo '</table>';
