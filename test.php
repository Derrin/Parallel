...
<?php
    ...
    if ($json === false) {
        ...
        if (count(get_object_vars($results)) == 0) {
            ...
            echo '<tr><td><b>Neck</b></td><td></td></tr>';
            echo '<tr><td><b>Shoulder</b></td><td></td></tr>';
            echo '<tr><td><b>Back</b></td><td></td></tr>';
            echo '<tr><td><b>Chest</b></td><td></td></tr>';
            echo '<tr><td><b>Wrists</b></td><td></td></tr>';
            echo '<tr><td><b>Hands</b></td><td></td></tr>';
            echo '<tr><td><b>Waist</b></td><td></td></tr>';
            echo '<tr><td><b>Legs</b></td><td></td></tr>';
            echo '<tr><td><b>Feet</b></td><td></td></tr>';
            echo '<tr><td><b>Finger 1</b></td><td></td></tr>';
            echo '<tr><td><b>Finger 2</b></td><td></td></tr>';
            echo '<tr><td><b>Trinket 1</b></td><td></td></tr>';
            echo '<tr><td><b>Trinket 2</b></td><td></td></tr>';
            echo '<tr><td><b>Weapon</b></td><td></td></tr>';
            echo '<tr><td><b>Off Hand</b></td><td></td></tr>';
            echo '<tr><td><b>Shirt</b></td><td></td></tr>';
            echo '<tr><td><b>Tabard</b></td><td></td></tr>';
            echo '</table>';
